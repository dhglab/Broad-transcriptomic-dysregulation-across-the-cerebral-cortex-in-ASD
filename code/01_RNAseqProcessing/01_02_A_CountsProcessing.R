...
save(datExpr,datMeta,datSeq,datSeq_numeric,rsem_gene_effLen,file="data_user/01_RNAseqProcessing/01_02_A_02_NormalizedGeneFilteredRNAseq.RData")

rm(list=ls())

##### (3) Outlier Removal #####

load("data_user/01_RNAseqProcessing/01_02_A_02_NormalizedGeneFilteredRNAseq.RData")
...
save(datExpr,datMeta,datSeq_model,datSeq_numeric,topPC,rsem_gene_effLen,file="data_user/01_RNAseqProcessing/01_02_A_03_NormalizedOutliersRemovedRNAseq.RData")

##### (4) Prepare Metadata for Linear Model Building #####

rm(list=ls())
load(file="data_user/01_RNAseqProcessing/01_02_A_03_NormalizedOutliersRemovedRNAseq.RData")
...
save(datMeta_model,datSeq_model,datExpr,file="data_user/01_RNAseqProcessing/01_02_A_04_dat4MARS.RData")

datMeta_model = datMeta_model_org

save(datExpr,datMeta,datSeq_numeric,datMeta_model,datSeq_model,topPC,rsem_gene_effLen,
     file="data_user/01_RNAseqProcessing/01_02_A_04_AllDataPreMARS.RData")
...
load("data_user/01_RNAseqProcessing/01_02_A_04_dat4MARS.RData")
...
if(TRUE | !file.exists(paste0(output,"/01_02_A_05_MARSOutput.RData")))  {
  
  e.all = runMARS(gene.expr = Y, covars = X.all, n.replicates = 1, allow.interaction = F,batch.interactions=F,allow.nonlinear=F)
  save(e.all, file=paste0(output,"/01_02_A_05_MARSOutput.RData"))
  
  beta_e_all=e.all[[1]]$beta
  coef_e_all=e.all[[1]]$e$coefficients
  
  save(beta_e_all,coef_e_all,file=paste0(output,"/01_02_A_05_MARSOutput_subset.RData"))
}
...
save(cv_coef_list,cv_r2_list,cv_rsq_all,file==paste0(output,"/01_02_A_05_MARSOutput_CVCompiled.RData"))
...
load("data_user/01_RNAseqProcessing/01_02_A_04_AllDataPreMARS.RData")
load("data_provided/01_RNAseqProcessing/01_02_A_05_MARSOutput_subset.RData")
load("data_provided/01_RNAseqProcessing/01_02_A_05_MARSOutput_CVCompiled.RData")

pdf(file="plots/01_RNAseqProcessing/01_02_A_06_MARS_CV_plots.pdf",width=16,height=12)
for(i in c(1:10)){
...
save(datExpr,form,datMeta_model_vp,file="data_user/01_RNAseqProcessing/01_02_A_06_VarPartData.RData")

datSeq = datSeq_model

save(datMeta_model,datMeta,datSeq,datSeq_numeric,
     topPC,datExpr,rsem_gene_effLen,file="data_user/01_RNAseqProcessing/01_02_A_06_AllProcessedData_wModelMatrix.RData")

##### (7) Partition Variance Across Covariates #####

### It is recommended to run this section on a high-performance computing cluster.

load("data_user/01_RNAseqProcessing/01_02_A_06_VarPartData.RData")

varPart <- fitExtractVarPartModel( datExpr, form, datMeta_model )

save(varPart,file="data_user/01_RNAseqProcessing/01_02_A_07_VarPartResults.RData")

vp <- sortCols( varPart )

pdf(file="plots/01_RNAseqProcessing/01_02_A_07_varPartPlot.pdf",width=18,height=12)
...
load("data_user/01_RNAseqProcessing/01_02_A_06_AllProcessedData_wModelMatrix.RData")
...
save(datExpr.reg,topPC_reg,file="data_user/01_RNAseqProcessing/01_02_A_08_RegressedExpression.RData")
...
save(datExpr.reg,topPC_reg,file="data_user/01_RNAseqProcessing/01_02_A_08_RegressedExpression_TRI.RData")
