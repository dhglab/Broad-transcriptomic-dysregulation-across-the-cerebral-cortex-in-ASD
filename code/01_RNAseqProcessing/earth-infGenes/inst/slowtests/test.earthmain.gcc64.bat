...
cp "C:/Program Files/R/R-3.4.3/bin/x64/R.dll" .
                                @if %errorlevel% neq 0 goto error
cp "C:/Program Files/R/R-3.4.3/bin/x64/Rblas.dll" .
                                @if %errorlevel% neq 0 goto error
cp "C:/Program Files/R/R-3.4.3/bin/x64/Riconv.dll" .
                                @if %errorlevel% neq 0 goto error
cp "C:/Program Files/R/R-3.4.3/bin/x64/Rgraphapp.dll" .
                                @if %errorlevel% neq 0 goto error
@rem cp "C:/Program Files/R/R-3.4.3/bin/x64/Rzlib.dll" .
